...
from uploadapi.database import comment_table, database, like_table, post_table
from uploadapi.models.post import (
    Comment,
    CommentIn,
    PostLike,
    PostLikeIn,
...
from uploadapi.models.user import User
from uploadapi.security import get_current_user
